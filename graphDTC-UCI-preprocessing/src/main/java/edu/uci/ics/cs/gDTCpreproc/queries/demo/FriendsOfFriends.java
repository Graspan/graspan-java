package edu.uci.ics.cs.gDTCpreproc.queries.demo;
...
import edu.uci.ics.cs.gDTCpreproc.queries.VertexQuery;
import edu.uci.ics.cs.gDTCpreproc.util.IdCount;
import edu.uci.ics.cs.gDTCpreproc.util.MultinomialSampler;
import edu.uci.ics.cs.gDTCpreproc.vertexdata.VertexAggregator;
import edu.uci.ics.cs.gDTCpreproc.vertexdata.VertexIdValue;
