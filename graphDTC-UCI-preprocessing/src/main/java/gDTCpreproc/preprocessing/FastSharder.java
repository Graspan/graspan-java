package gDTCpreproc.preprocessing;

import gDTCpreproc.ChiFilenames;
import gDTCpreproc.ChiLogger;
import gDTCpreproc.ChiVertex;
import gDTCpreproc.datablocks.BytesToValueConverter;
import gDTCpreproc.datablocks.ChiPointer;
import gDTCpreproc.datablocks.DataBlockManager;
import gDTCpreproc.datablocks.IntConverter;
import gDTCpreproc.engine.auxdata.VertexData;
import gDTCpreproc.io.CompressedIO;
import gDTCpreproc.shards.MemoryShard;
import gDTCpreproc.shards.SlidingShard;
...
public class FastSharder <VertexValueType, EdgeValueType> {
    ...
    public void process() throws IOException {
         ...
         * of each vertex. See gDTCpreproc.engine.auxdata.DegreeData
         */
        if (!memoryEfficientDegreeCount) {
            writeDegrees();
        } else {
